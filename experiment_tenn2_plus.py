...
class ConnorMillingExperiment(TennExperiment):
    ...
    def __init__(self, args):
        ...
        if self.use_caspian:
            ...
            self.controller, self.controller_remapped = CaspianBinaryControllerPlus, CaspianBinaryControllerPlus
        else:
        ...
        self.log("initialized experiment_tenn2_plus")
    ...
    def simulate(self, processor, network, init_callback=lambda x: x):
        ...
        if self.use_caspian:
            from rss.CaspianBinaryControllerPlus import CaspianBinaryControllerPlus
            register_dictlike_type('controller', "CaspianBinaryController", CaspianBinaryControllerPlus)
            register_dictlike_type('controller', "CaspianBinaryRemappedController", CaspianBinaryControllerPlus)
        else:
            from rss.CasPyanBinaryController import CasPyanBinaryController
            from rss.CasPyanBinaryRemappedController import CasPyanBinaryRemappedController
