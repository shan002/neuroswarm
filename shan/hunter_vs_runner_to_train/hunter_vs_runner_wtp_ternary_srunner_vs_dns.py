...
from SRunnerController_VS import SRunnerController_VS
...
from CatchRunnerMetricWTP_DNS import CatchRunnerMetricWTP_DNS
...
class HunterVsRunnerExperiment(TennExperiment):
    ...
    def simulate(self, processor, network, init_callback=lambda config: config):
        ...
        register_dictlike_type('controller', "SRunnerController_VS", SRunnerController_VS)
        ...
        # Override the controller to use SRunnerController_VS.
        runner_config.controller = {"type": "SRunnerController_VS", "speed": runner_speed, "turn_rate": runner_turn_rate}
        ...
        config.metrics = [CatchRunnerMetricWTP_DNS()]
