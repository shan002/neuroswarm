...
class HunterVsRunnerExperiment(TennExperiment):
    def __init__(self, args):
        ...
        self.run_info = None
        self.n_inputs, self.n_outputs, _, _ = CaspianTernaryController.get_default_encoders()
...
# python hunter_vs_runner_ternary.py run --root ~/neuromorphic/turtwig/results_sim/hopper/250724/6-wtp-2/ --cy 3000 -T 2 --trial_seed 42 --plot_fit
